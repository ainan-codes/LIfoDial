...
_PHRASES: dict[str, dict[str, str]] = {
    "en-IN": _EN,
    "hi-IN": {
        BOOKED: "आपकी अपॉइंटमेंट पक्की हो गई है।",
        CANCELLED: "आपकी अपॉइंटमेंट रद्द कर दी गई है।",
        RESCHEDULED: "आपकी अपॉइंटमेंट बदल दी गई है।",
        ACTION_FAILED: (
    ...
    "ml-IN": {
        BOOKED: "നിങ്ങളുടെ അപ്പോയിന്റ്മെന്റ് ഉറപ്പിച്ചു.",
        CANCELLED: "നിങ്ങളുടെ അപ്പോയിന്റ്മെന്റ് റദ്ദാക്കി.",
        RESCHEDULED: "നിങ്ങളുടെ അപ്പോയിന്റ്മെന്റ് മാറ്റി.",
        ACTION_FAILED: (
    ...
    "ta-IN": {
        BOOKED: "உங்கள் சந்திப்பு உறுதி செய்யப்பட்டது.",
        CANCELLED: "உங்கள் சந்திப்பு ரத்து செய்யப்பட்டது.",
        RESCHEDULED: "உங்கள் சந்திப்பு மாற்றப்பட்டது.",
        ACTION_FAILED: (
    ...
    "kn-IN": {
        BOOKED: "ನಿಮ್ಮ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ದೃಢಪಟ್ಟಿದೆ.",
        CANCELLED: "ನಿಮ್ಮ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ರದ್ದಾಗಿದೆ.",
        RESCHEDULED: "ನಿಮ್ಮ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಬದಲಾಗಿದೆ.",
        ACTION_FAILED: (
    ...
    "te-IN": {
        BOOKED: "మీ అపాయింట్‌మెంట్ ఖరారైంది.",
        CANCELLED: "మీ అపాయింట్‌మెంట్ రద్దు చేయబడింది.",
        RESCHEDULED: "మీ అపాయింట్‌మెంట్ మార్చబడింది.",
        ACTION_FAILED: (
    ...
    "mr-IN": {
        BOOKED: "तुमची अपॉइंटमेंट निश्चित झाली आहे.",
        CANCELLED: "तुमची अपॉइंटमेंट रद्द केली आहे.",
        RESCHEDULED: "तुमची अपॉइंटमेंट बदलली आहे.",
        ACTION_FAILED: (
