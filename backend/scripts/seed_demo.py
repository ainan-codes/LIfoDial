...
DEMO_CLINICS = [
    {
        ...
        "agent": {
            "id": "agent-001",
            "agent_name": "Apollo Receptionist",
            "template": "clinic_receptionist",
            "first_message": "Namaste! Apollo Clinic mein aapka swagat hai. Main aapki AI receptionist hoon. Aaj main aapki kaise madad kar sakti hoon?",
    ...
    },
    {
        ...
        "agent": {
            "id": "agent-002",
            "agent_name": "Aster Receptionist",
            "template": "clinic_receptionist",
            "first_message": "നമസ്കാരം! Aster Medicity-ലേക്ക് സ്വാഗതം. ഞാൻ നിങ്ങളുടെ AI റിസപ്ഷനിസ്റ്റ് ആണ്. എങ്ങനെ സഹായിക്കാം?",
    ...
    },
    {
        ...
        "agent": {
            "id": "agent-003",
            "agent_name": "Max Receptionist",
            "template": "clinic_receptionist",
            "first_message": "Hello! Welcome to Max Healthcare Delhi. I am your AI receptionist. How can I assist you today?",
            "system_prompt": "You are the AI receptionist for Max Healthcare Delhi. Help patients in Hindi or English. Book appointments. Keep responses under 2 sentences. Available: Dr. Anil Kapoor (Neurology), Dr. Sunita Verma (Paediatrics), Dr. Rahul Singh (Orthopaedic).",
            "stt_provider": "sarvam",
            "stt_model": "saaras:v3",
            "stt_language": "en-IN",
            "tts_provider": "sarvam",
    ...
    },
    {
        ...
        "agent": {
            "id": "agent-004",
            "agent_name": "Manipal Receptionist",
            "template": "clinic_receptionist",
            "first_message": "Namaskara! Manipal Hospitals ge swagata. Naanu nimma AI receptionist. Nimage hege sahaya maadali?",
            "system_prompt": "You are the AI receptionist for Manipal Hospitals Bangalore. Respond in Kannada primarily, switch to English if needed. Help book appointments. Keep responses under 2 sentences. Available: Dr. Lakshmi Prasad (Cardiology), Dr. Rohan D'Souza (General).",
            "stt_provider": "sarvam",
            "stt_model": "saaras:v3",
            "stt_language": "kn-IN",
            "tts_provider": "sarvam",
    ...
    },
    {
        ...
        "agent": {
            "id": "agent-005",
            "agent_name": "Al Zahra Receptionist",
            "template": "clinic_receptionist",
            "first_message": "مرحباً! أهلاً وسهلاً بك في مستشفى الزهراء. أنا موظفة الاستقبال الذكية. كيف يمكنني مساعدتك؟",
            "system_prompt": "You are the AI receptionist for Al Zahra Hospital Dubai. Respond in Arabic primarily, switch to English if needed. Help book appointments. Keep responses under 2 sentences. Available: Dr. Ahmed Al Rashidi (General), Dr. Sara Khalil (Gynaecology).",
            "stt_provider": "sarvam",
            "stt_model": "saaras:v3",
            "stt_language": "ar-SA",
            "tts_provider": "sarvam",
