...
PROVIDERS = {
    "llm": [
        ...
        {"id": "groq",      "name": "Groq",             "env_var": "GROQ_API_KEY",
         "models": ["llama-3.3-70b-versatile", "llama-3.1-8b-instant", "moonshard-llama-3.3-70b-32k", "gemma2-9b-it", "llama-3.2-90b-vision-preview", "deepseek-r1-distill-llama-70b", "compound-beta", "compound-beta-mini"],
